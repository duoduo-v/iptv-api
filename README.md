...
<br>
<p align="center">
  <a href="https://github.com/52liulian/iptv-api/releases/latest">
    <img src="https://img.shields.io/github/v/release/52liulian/iptv-api" />
  </a>
  <a href="https://www.python.org/">
    <img src="https://img.shields.io/badge/python-%20%3D%203.13-47c219" />
  </a>
  <a href="https://github.com/52liulian/iptv-api/releases/latest">
    <img src="https://img.shields.io/github/downloads/52liulian/iptv-api/total" />
  </a>
  <a href="https://hub.docker.com/repository/docker/guovern/iptv-api">
    <img src="https://img.shields.io/docker/pulls/guovern/iptv-api" />
  </a>
  <a href="https://github.com/52liulian/iptv-api/fork">
    <img src="https://img.shields.io/github/forks/52liulian/iptv-api" />
  </a>
</p>

[English](./README_en.md) | 中文

🎉💻[IPTV-Web](https://github.com/52liulian/iptv-web)：IPTV电视直播源管理平台，支持在线播放等功能，开发中...
...
```bash
https://raw.githubusercontent.com/52liulian/iptv-api/gd/output/result.m3u
```

```bash
https://raw.githubusercontent.com/52liulian/iptv-api/gd/output/result.txt
```

或

```bash
https://cdn.jsdelivr.net/gh/52liulian/iptv-api@gd/output/result.m3u
```

```bash
https://cdn.jsdelivr.net/gh/52liulian/iptv-api@gd/output/result.txt
```

- 数据源：

```bash
https://raw.githubusercontent.com/52liulian/iptv-api/gd/source.json
```

或

```bash
https://cdn.jsdelivr.net/gh/52liulian/iptv-api@gd/source.json
```
...
1. 下载[IPTV-API 更新软件](https://github.com/52liulian/iptv-api/releases)，打开软件，点击更新，即可完成更新
...
[MIT](./LICENSE) License &copy; 2024-PRESENT [Govin](https://github.com/52liulian)
